        ...
        with Profiler("GSPE_Run") as p:
            ...
            for scale in self.scale_hypotheses:
                for rot in self.rotation_hypotheses:
                    ...
                    # 5. Hybrid Score
                   # Raw structural matching should dominate.
                   # Low-frequency matching is retained only as a stabilizing signal,
		   # because periodic semiconductor layouts can create broad false peaks.
                    res = 0.85 * res_raw + 0.15 * res_lowfreq                    
